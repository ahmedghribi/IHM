                ...
                <div class="s_product_img">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <ol class="carousel-indicators">
                            ...
                            <li data-target="#carouselExampleIndicators" data-slide-to="{{$loop->index}}" @if($loop->
                                index == 0) class="active" @endif>
                                <img src="{{asset('images/product/small/'.$image->image)}}" alt="{{$product->title}}"
                                    width="60" height="60" />
                            </li>
                            @endforeach
                        </ol>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item @if($loop->index == 0) active @endif">
                                <img class="d-block w-100" src="{{asset('images/product/'.$image->image)}}"
                                    alt="{{$product->title}}" />
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <ul class="list">
                        @if($product->category)
                        <li><a class="active"
                                href="{{route('shop.category', $product->category->slug)}}"><span>Category</span> :
                                {{$product->category->name}}</a></li>
                        @endif
                        @if($product->brand)
                        <li><a class="active" href="{{route('shop.brand', $product->brand->slug)}}"><span>Brand</span> :
                                {{$product->brand->name}}</a></li>
                        @endif
                        <li>
                            <a href="{{route('shop.single', $product->slug)}}"> <span>Availibility</span> :
                                {{$product->quantity}} In Stock</a>
                        </li>
                    </ul>
                    <p>
        ...
        <div class="tab-content" id="myTabContent">
                    ...
                    <div class="col-lg-6">
                        <div class="review_box" id="commentFormContainer">
                            ...
                            <form method="post" class="row contact_form"
                                action="{{ route('product.comments.store'   ) }}" id="commentForm">
                                {{csrf_field()}}

                                @guest
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="comments_name" name="name"
                                            placeholder="Your Full name" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="comments_email" name="email"
                                            placeholder="Email Address" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="comments_number" name="phone"
                                            placeholder="Phone Number" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="comments_website" name="website"
                                            placeholder="Website" />
                                    </div>
                                </div>
                                @endguest
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="body" id="comments_message" rows="3"
            ...
            <li>
              <i class="fa fa-star-o" title="1" data-value="1"></i>
                            ...
                            <form method="post" class="row contact_form" action="{{ route('product.review.store'   ) }}"
                                id="reviewForm">
                                {{csrf_field()}}
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="review_website"
                                            name="review_website" placeholder="Website" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="review_number" name="review_phone"
                                            placeholder="Phone Number" />
                                    </div>
                                </div>
                                @endguest
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="review_body" id="review_message" rows="3"
                                            placeholder="Message"></textarea>
