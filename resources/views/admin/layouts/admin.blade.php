      ...
      <li class="nav-item active">
        ...
        <li class="nav-item">
          ...
          <div id="collapseProduct" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('admin.product')}}">Produits</a>
              <a class="collapse-item" href="{{route('admin.product.create')}}">Ajouter Produits</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseCategory" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Catégorie Options:</h6>
              <a class="collapse-item" href="{{route('admin.product.category')}}">Catégorie</a>
              <a class="collapse-item" href="{{route('admin.product.category.create')}}">Ajouter Catégorie</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseBrand" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Marque Options:</h6>
              <a class="collapse-item" href="{{route('admin.product.brand')}}">Marque</a>
              <a class="collapse-item" href="{{route('admin.product.brand.create')}}">Ajouter marque</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseCurrency" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Devise Options:</h6>
              <a class="collapse-item" href="{{route('admin.currency')}}">Devise</a>
              <a class="collapse-item" href="{{route('admin.currency.create')}}">Ajouter Devise</a>
            </div>
          </div>
        </li>
        <!-- Nav Item - Pages Collapse Menu -->
        ...
        <li class="nav-item">
          ...
          <div id="collapsePost" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Articles Options:</h6>
              <a class="collapse-item" href="{{route('admin.post')}}">Articles</a>
              <a class="collapse-item" href="{{route('admin.post.create')}}">Ajouter Articles</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapsePostCategory" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('admin.post.category.create')}}">Ajouter Categories</a>
            </div>
          </div>
        </li>
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
          ...
          <div id="collapseTag" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('admin.post.tag.create')}}">Ajouter tag</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseSlider" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('admin.slider.create')}}">Ajouter slider </a>
            </div>
          </div>
        </li>
          ...
          <footer class="sticky-footer bg-white">
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>Copyright &copy; <a href="#" target="_blank">AhmedGhribi</a> 2019</span>
              </div>
            </div>
          </footer>
          <!-- End of Footer -->
